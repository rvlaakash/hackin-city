...
router.post('/add-user', function(req, res, next) {
  const formdata={
    ...
    user_collage: req.body.collage,
    user_university: req.body.university,
    user_team_name: req.body.team_name,
    user_team_id: req.body.team_id,
  }
...
router.post('/edit/:id' , function(req,res){
  ...
  const mybodydata={
    ...
    user_collage: req.body.user_collage,
    user_university: req.body.user_university,
    user_team_name: req.body.user_team_name,
